...
4. If you need a refresher on JavaScript syntax, go to the [Javascript Basics](https://www.udacity.com/course/javascript-basics--ud804) course; if you would like to understand how this project is manipulating and traversing the DOM, check out [Intro to jQuery](https://www.udacity.com/course/intro-to-jquery--ud245).
5. Go through the videos and assignments in this course to learn the JavaScript necessary to build your resume.
6. If you are prompted to do so, you may want to get a [Google Maps API key](https://developers.google.com/maps/documentation/javascript/get-api-key), and include it as the value of the `key` parameter when loading the Google Maps API in **index.html**:
...
7. Last but not least, You will be provided with simple server to handle XHR requests of form where You will showcase your skills of AJAX mastering.
8. Detailed information is annotated in index.pug file inside cloned repository.
9. Server developed by yourself will gain extra points.
10. ES6 way of doing stuff is preferable and will gain extra points.
12. Don't forget to refactor your code according to BEM metodology, pug and stylus.
13. Good luck.

P.S. To launch server

1. You should install all the dependencies from package.json via 
```
  npm install
```
2. install nodemon via 
```
